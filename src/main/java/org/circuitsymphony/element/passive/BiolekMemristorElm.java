...
public class BiolekMemristorElm extends CircuitElm {
    private double r_on;
...
//    protected static final int MEM_SILLIN = 6;
    ...
    public BiolekMemristorElm(CircuitEngine engine, int xx, int yy) {
        super(engine, xx, yy);
        r_on = 100;
        r_off = 160 * r_on;
        dopeWidth = 0;
...
//        memtype = MEM_SILLIN;
    ...
    public BiolekMemristorElm(CircuitEngine engine, int xa, int ya, int xb, int yb, int f,
                              StringTokenizer st) {
        this(engine, xa, ya, xb, yb, f, 0, st);
    }

    public BiolekMemristorElm(CircuitEngine engine, int xa, int ya, int xb, int yb, int f, int f2,
                              StringTokenizer st) {
...
//        }
        ...
        if (n == 5)
            return new EditInfo("Window factor pos integer ", g , 0, 1e9);
//        if (n == 7)
