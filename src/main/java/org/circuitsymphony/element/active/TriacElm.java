...
public class TriacElm extends CircuitElm {
    ...
    public TriacElm(CircuitEngine engine, int xx, int yy) {
        super(engine, xx, yy);
        setDefaults();
        setup();
    }

    public TriacElm(CircuitEngine engine, int xa, int ya, int xb, int yb, int f,
                    StringTokenizer st) {
        this(engine, xa, ya, xb, yb, f, 0, st);
    }

    public TriacElm(CircuitEngine engine, int xa, int ya, int xb, int yb, int f, int f2,
                    StringTokenizer st) {
