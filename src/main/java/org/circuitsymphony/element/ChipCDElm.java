...
public abstract class ChipCDElm extends CircuitElm {
    ...
    private final int SIDE_N = 0;
    private final int SIDE_S = 1;
    public int bits;
    public Pin pins[];
    ...
    public ChipCDElm(CircuitEngine engine, int xx, int yy) {
        super(engine, xx, yy);
    ...
    public ChipCDElm(CircuitEngine engine, int xa, int ya, int xb, int yb, int f, StringTokenizer st) {
        this(engine, xa, ya, xb, yb, f, 0, st);
    }

    public ChipCDElm(CircuitEngine engine, int xa, int ya, int xb, int yb, int f, int f2, StringTokenizer st) {
    ...
    private void drawChip(DrawContext ctx) {
        int i;
