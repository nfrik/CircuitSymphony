...
public class CounterElm extends ChipElm {
    ...
    public CounterElm(CircuitEngine engine, int xx, int yy) {
        super(engine, xx, yy);
    }

    public CounterElm(CircuitEngine engine, int xa, int ya, int xb, int yb, int f,
                      StringTokenizer st) {
        this(engine, xa, ya, xb, yb, f, 0, st);
    }

    public CounterElm(CircuitEngine engine, int xa, int ya, int xb, int yb, int f, int f2,
                      StringTokenizer st) {
